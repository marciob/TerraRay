...
export declare namespace AgroTypes {
  export type FarmerDataStruct = {
    approved: boolean;
    riskTier: BigNumberish;
    cropType: BigNumberish;
    region: BigNumberish;
    metadataURI: string;
  };

  export type FarmerDataStructOutput = [
    approved: boolean,
    riskTier: bigint,
    cropType: bigint,
    region: bigint,
...
export interface FarmerRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "registerOrUpdateFarmer",
    values: [
      AddressLike,
      boolean,
      BigNumberish,
...
export namespace FarmerRegisteredEvent {
  export type InputTuple = [
    farmer: AddressLike,
    data: AgroTypes.FarmerDataStruct
  ];
  export type OutputTuple = [
    farmer: string,
    data: AgroTypes.FarmerDataStructOutput
  ];
...
export interface FarmerRegistry extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "registerOrUpdateFarmer"
  ): TypedContractMethod<
    [
      farmer: AddressLike,
      approved: boolean,
  ...
  getEvent(
    ...
    FarmerUpdatedEvent.InputTuple,
    FarmerUpdatedEvent.OutputTuple,
    FarmerUpdatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "FarmerRegistered(address,tuple)": TypedContractEvent<
      FarmerRegisteredEvent.InputTuple,
      FarmerRegisteredEvent.OutputTuple,
      FarmerRegisteredEvent.OutputObject
    >;
    ...
    "FarmerUpdated(address,tuple)": TypedContractEvent<
      FarmerUpdatedEvent.InputTuple,
      FarmerUpdatedEvent.OutputTuple,
      FarmerUpdatedEvent.OutputObject
    >;
    FarmerUpdated: TypedContractEvent<
      FarmerUpdatedEvent.InputTuple,
      FarmerUpdatedEvent.OutputTuple,
      FarmerUpdatedEvent.OutputObject
    >;
