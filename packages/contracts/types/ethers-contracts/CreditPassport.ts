...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface CreditPassportInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "burn" | "getApproved" | "getTokenIdByFarmer" | "isApprovedForAll" | "mintPassport" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership" | "updateMetadata"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "MetadataUpdated" | "OwnershipTransferred" | "PassportMinted" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'burn', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'getApproved', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'getTokenIdByFarmer', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'mintPassport', values: [AddressLike, string]): string;
...
decodeFunctionResult(functionFragment: 'getTokenIdByFarmer', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'isApprovedForAll', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'mintPassport', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'updateMetadata', data: BytesLike): Result;
    ...
    export namespace PassportMintedEvent {
      export type InputTuple = [tokenId: BigNumberish, farmer: AddressLike, metadataURI: string];
      export type OutputTuple = [tokenId: bigint, farmer: string, metadataURI: string];
      export interface OutputObject {tokenId: bigint, farmer: string, metadataURI: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface CreditPassport extends BaseContract {
    
    connect(runner?: ContractRunner | null): CreditPassport;
    waitForDeployment(): Promise<this>;

    interface: CreditPassportInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getTokenIdByFarmer: TypedContractMethod<
      [farmer: AddressLike, ],
      [bigint],
      'view'
    >
    ...
    mintPassport: TypedContractMethod<
      [farmer: AddressLike, metadataURI: string, ],
      [bigint],
      'nonpayable'
    >
    ...
    updateMetadata: TypedContractMethod<
      [tokenId: BigNumberish, newMetadataURI: string, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'getApproved'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getTokenIdByFarmer'): TypedContractMethod<
      [farmer: AddressLike, ],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'mintPassport'): TypedContractMethod<
      [farmer: AddressLike, metadataURI: string, ],
      [bigint],
      'nonpayable'
    >;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'PassportMinted(uint256,address,string)': TypedContractEvent<PassportMintedEvent.InputTuple, PassportMintedEvent.OutputTuple, PassportMintedEvent.OutputObject>;
