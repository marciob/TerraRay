...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface RaylsSemaphoreVerifierInterface extends Interface {
  ...
  export interface RaylsSemaphoreVerifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): RaylsSemaphoreVerifier;
    waitForDeployment(): Promise<this>;

    interface: RaylsSemaphoreVerifierInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    verifyProof: TypedContractMethod<
      [_pA: [BigNumberish, BigNumberish], _pB: [[BigNumberish, BigNumberish], [BigNumberish, BigNumberish]], _pC: [BigNumberish, BigNumberish], _pubSignals: [BigNumberish, BigNumberish, BigNumberish, BigNumberish], merkleTreeDepth: BigNumberish, ],
      [boolean],
      'view'
    >
