...
export declare namespace ISemaphore {
  ...
  export interface RaylsSemaphoreInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'verifyProof', data: BytesLike): Result;
  ...
  export interface RaylsSemaphore extends BaseContract {
    
    connect(runner?: ContractRunner | null): RaylsSemaphore;
    waitForDeployment(): Promise<this>;

    interface: RaylsSemaphoreInterface;
